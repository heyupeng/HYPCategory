...
CGFloat yp_CGPointGetAngle(CGPoint point) {
    CGFloat angle = 0;
    CGFloat dx, dy;
...
/// @param point 圆弧上的点
/// @param center 圆心点
CGFloat yp_CGPointGetAngleWithCenterPoint(CGPoint point, CGPoint center) {
    CGFloat dx = point.x - center.x;
    CGFloat dy = point.y - center.y;
    return yp_CGPointGetAngle(CGPointMake(dx, dy));
}
